...
{
    public record RestaurantDto(int Id, string Name, string Slug, string LogoUrl, string Address, string Phone, bool IsActive);
    ...
    public record CreateRestaurantDto(string Name, string Slug, string LogoUrl, string Address, string Phone);
